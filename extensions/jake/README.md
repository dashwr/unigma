...
This extension supports running [Jake](http://jakejs.com/) tasks defined in a `Jakefile.js` file as unigma tasks. Jake tasks with the name 'build', 'compile', or 'watch' are treated as build tasks.
