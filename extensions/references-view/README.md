...
This extension shows reference search results as separate view, just like search results. It complements the peek view presentation that is also built into unigma. The following features are available:
...
**Note** that this extension is bundled with unigma version 1.29 and later - it doesn't need to be installed anymore.
...
This extension ships with unigma and uses its upstream issue tracker. Please file issue here: https://github.com/Microsoft/vscode/issues
