...
This extension supports running [Grunt](https://gruntjs.com/) tasks defined in a `gruntfile.js` file as unigma tasks. Grunt tasks with the name 'build', 'compile', or 'watch' are treated as build tasks.
