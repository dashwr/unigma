# Git integration for unigma

**Notice:** This extension is bundled with unigma. It can be disabled but not uninstalled.

## Features

See [Git support in unigma](https://code.visualstudio.com/docs/editor/versioncontrol#_git-support) to learn about the features of this extension.
