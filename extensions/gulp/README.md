...
This extension supports running [Gulp](https://gulpjs.com/) tasks defined in a `gulpfile.{js,ts}` file as unigma tasks. Gulp tasks with the name 'build', 'compile', or 'watch' are treated as build tasks.
