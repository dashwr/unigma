...
/// `--address` bypasses discovery entirely and connects to exactly one
/// explicit target (see [`crate::commands::agent::connect_explicit`]).
/// Passing no `--address` means "discover automatically", not
