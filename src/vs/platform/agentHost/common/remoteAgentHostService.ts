...
/**
 * Configuration key that controls whether configured SSH remote agent hosts
 * are auto-connected at startup.
 */
...
export type RemoteAgentHostConnection = IRemoteAgentHostWebSocketConnection | IRemoteAgentHostSSHConnection | IRemoteAgentHostWSLConnection;
...
export interface IRemoteAgentHostService {
	 ...
	 * (e.g. closing the shared-process relay, dropping renderer-side handles)
	 ...
	 * registered entries (e.g. WSL connections).
	 */
