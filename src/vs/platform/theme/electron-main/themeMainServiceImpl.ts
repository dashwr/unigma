...
namespace Setting {
	...
	export const STARTUP_EDITOR = new Setting<'none' | 'welcomePage' | 'readme' | 'newUntitledFile' | 'welcomePageInEmptyWorkbench' | 'terminal'>('workbench.startupEditor', 'welcomePage');
}
