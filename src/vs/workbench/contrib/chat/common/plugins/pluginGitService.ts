 ...
 * | ---------------------------------- | ------------------------------- | ------------------------------------------------------- | ---------------------------------------------------------------------- |
 * | Desktop                           | `NativePluginGitCommandService` | Real `git` via `ILocalGitService` in the shared process | `chat/test/electron-browser/pluginGitCommandService.test.ts`           |
 * | Web                               | `BrowserPluginGitCommandService`| GitHub tarball fetch + extract into virtual FS          | `chat/test/browser/pluginGitCommandService.test.ts`                    |
 *
