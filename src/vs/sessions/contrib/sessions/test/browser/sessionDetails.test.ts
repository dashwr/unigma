	...
	test('lists exact working directories for non-archived user sessions', () => {
		...
		const workspace: ISessionWorkspace = {
			...
			folders: [
				...
				{
					root: URI.parse('test-remote://host/home/user/repo'),
					workingDirectory: URI.parse('test-remote://host/home/user/repo'),
					name: 'remote-repo',
					description: undefined,
				},
			],
		...
		assert.strictEqual(formatSessionDetails([working, archived, automation, quickChat]), [
			...
			'Working directory: test-remote://host/home/user/repo',
