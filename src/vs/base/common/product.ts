...
export interface IProductConfiguration {
	...
	/** Whether the legacy workbench chat panel is part of this product. */
	readonly chatPanelEnabled?: boolean;
...
export function isChatPanelEnabled(product: Pick<IProductConfiguration, 'chatPanelEnabled'>): boolean {
	return product.chatPanelEnabled !== false;
}
