...
| [EM REVISÃO] T-011 / E01 | Par `openrouter`/`nemotron-3.5-lightning:free` **provado** no runner `34052368433` (`prompt-answered=pass`) | Um par respondendo não é suporte a provider: faltam eventos, reinício e versão incompatível |
