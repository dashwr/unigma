...
| 2026-08-31 | `T-043` | implementação → `partial` | `/doc` do OpenCode `1.18.23` confirmou `/command` e `/skill`; contrato/catalogo transitório, parser e autocomplete nativos foram commitados; push para validação falhou com 403 no remoto `dashwr/unigma`, sem promoção de aceite |
