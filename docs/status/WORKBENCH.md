...
| ambiente | `T-052` / `AC-007` | falta a ativação remota, a fiação do resolver e o smoke; o transporte, o par, o manifesto e o plano de staging já existem. O bloqueio de host caiu: esta máquina e o WSL do runner são Linux x64 com `sshd` disponível | próxima frente |
