...
| 2026-09-01 | providers/modelos | implementação parcial | runtime passou a consultar `/provider?directory=` sob trust/preflight e emitir apenas IDs/rótulos sanitizados; 69 testes do runtime passaram. UI, preferência global e seleção explícita seguem pendentes |
